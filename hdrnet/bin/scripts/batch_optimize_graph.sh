...
#
# batch version of hdrnet optimize_graphy.sh. You just need to put all the tasks to corresponding folder. That's it. You are done.
#
...
if __name__ == "__main__":
    ...
    task_cmd0 = os.path.join(os.path.dirname(os.path.realpath(__file__)),'optimize_graph.sh ')
